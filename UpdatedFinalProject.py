...
def menu():
    ...
    logo.center = 600, 450
    InstructionText = font2.render("Instructions:", True, (255, 255, 255))
    display_surface.blit(InstructionText, background.topleft)
    WinText = font2.render("Defeat 10 Enemies to Win!", True, (255, 255, 255))
    display_surface.blit(WinText, (0, 25))
    PlayText = font2.render("Press 'A' To Play", True, (255, 255, 255))
    display_surface.blit(PlayText,(0,50))
